...
| **v1.8.3**  | December 19, 2023          | Security & Bugs            | Rather small| The last Legacy Update   | [stbchat@v1.8.3](https://github.com/Strawberry-Foundations/strawberry-chat/tree/1.8.3) |
| **v1.9.0**  | December 1, 2023           | Feature, security & bugs   | Very large | The Communication Update  | [stbchat@1.9.0](https://github.com/Strawberry-Foundations/strawberry-chat/tree/main) |
| **v1.10.0** | Not available              | Feature, security & bugs   | Large      | The Community Update      | [stbchat@python-legacy](https://github.com/Strawberry-Foundations/strawberry-chat/tree/python-legacy) |
| **v1.11.0** | April 19, 2024             | Feature, security & bugs   | Very large | Rusty Rewrite             | [stbchat@main](https://github.com/Strawberry-Foundations/strawberry-chat/tree/main) |
