...
<Warning>This documentation section only applies to Scapi Dev v0.12.0 (stbmv2) or higher</Warning>
...
<Warning>The argument `json` is only available since Scapi Dev v0.12.1</Warning>
<Warning>The argument `prefix` is only available since Scapi Dev v0.13.1b2</Warning>
...
| `enable_user_input`       | Activate message input within the console | 
| `log_msg`                 | Change the format of the log messages | 
| `ignore_capitalization`   | Activates or deactivates the ignoring of capital letters for the `on_message` method (**only available from Scapi Dev v0.13**) | 
...
<Info>
    ...
    The older method is deprecated since Scapi Dev v0.12.1 and should therefore no longer be used
</Info>
...
### Commands (Original Method)
<Warning>
    The official support for the [original method](/scapi/usage#commands-original-method) has been removed since Scapi Dev v0.12.1.
...
### Example bot (Dev v0.12.0 or higher)
<Warning>This documentation part only applies to scapi dev v0.12.0 (stbmv2) or higher</Warning>

<Warning>
    Official support for the [original method](/scapi/usage#commands-original-method) has been removed since Scapi Dev v0.12.1.
...
You can get Scapi Dev (`@json-communication`/`@main`) [here](https://raw.githubusercontent.com/Strawberry-Foundations/strawberry-chat/main/bot/scapi.py).
The following piece of code shows you how to make a simple bot with Scapi Dev
