...
<Warning>As of scapi v0.12.1, we will no longer support the [original method](/scapi/usage#write-your-first-bot-stable-v1-0-0-for-stbmv1). We may be planning an improved version of the original method.</Warning>
