...
<Warning>Dieser Dokumentationsteil gilt nur für Scapi Dev v0.12.0 (stbmv2) oder höher</Warning>
...
<Warning>Das Argument `json` ist erst seit Scapi Dev v0.12.1 verfügbar</Warning>
<Warning>Das Argument `prefix` ist erst seit Scapi Dev v0.13.1b2 verfügbar</Warning>
...
| `enable_user_input`       | Aktiviere die Nachrichteneingabe innerhalb der Konsole | 
| `log_msg`                 | Ändere das Format der Log-Nachrichten | 
| `ignore_capitalization`   | Aktiviert oder deaktiviert das ignorieren von Großbuchstaben für die `on_message` Methode (**Nur verfügbar ab Scapi Dev v0.13**) | 
...
<Info>
    ...
    Die ältere Methode ist seit Scapi Dev v0.12.1 veraltet und sollte daher auch nicht mehr verwendet werden
</Info>
...
### Commands (Originale Methode)
<Warning>
    Die Offizielle Unterstützung für die [Originale Methode](/german/scapi/usage#commands-originale-methode) wurde seit Scapi Dev v0.12.1 abgeschafft.
...
### Beispielbot (Dev v0.12.0 oder höher)
<Warning>Dieser Beispielbot gilt nur für Scapi Dev v0.12.0 (stbmv2) oder höher</Warning>
...
Scapi Dev ist aktuell in einer Entwicklungsphase und wird daher auch aktiv aktualisiert.
Du kannst Scapi Dev (`@json-communication`/`@main`) [hier](https://raw.githubusercontent.com/Strawberry-Foundations/strawberry-chat/main/bot/scapi.py) erhalten.
Die folgenden Code-Stücke zeigen dir wie du einen einfachen Bot mit Scapi Dev erstellen kannst.
