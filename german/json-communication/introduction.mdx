...
<CardGroup cols={1}>
  ...
  <Card title="Strawberry Communication Standard v3" icon="right-left-large" iconType="duotone" color="#55d799">
    ...
    Version 3 wird nicht vor 2024 erscheinen. Es könnte aber dazu kommen das wir einige Experimente durchführen um zu schauen ob das Performanceteschnisch probleme verursacht.
  </Card>
</CardGroup>

### Unterstützung

| Unterstützte Features  | stbcv1 | stbcv1 | stbcv2.1 | stbcv3 |
|------------------------|--------|--------|----------|--------|
| Python Strings¹        | ✅    | ✅     | ✅      | ✅     |
